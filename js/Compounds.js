  ...
  createAtoms: async function (element) {
    ...
    for(var num = 1; num<numOfElectron; num++){
      ...
      orbit.setAttribute("geometry",{
        primitive:"torus", arc: 360, radius: 0.28, radiusTubular:0.001
      })
      ...
      electronGroup.setAttribute("id", `electron-group-${
      elementName
      }`)
      electronGroup.setAttribute("rotation",{x:0, y:0, z:electronAngle})
      electronGroup += 65
      electronAngle.setAttribute("animation", {
        property:"rotation", to: `0 0 - 360`,loop:"true",dur:3500, easing:"lenient"
      })
